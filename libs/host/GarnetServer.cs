...
{normal}");
            ...
            store = new TsavoriteKV<SpanByte, SpanByte>(1024, logSettings, checkpointSettings, revivificationSettings: revivSettings, logger: this.loggerFactory?.CreateLogger("TsavoriteKV [main]"));
            ...
            if (!opts.DisableObjects)
            {
                ...
                objectStore = new TsavoriteKV<byte[], IGarnetObject>(1024, objLogSettings, objCheckpointSettings,
